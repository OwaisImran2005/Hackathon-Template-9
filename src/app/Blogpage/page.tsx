...
<div className="blogs mt-16 ">
    <img src={blog1.src} alt="" width={700} className="pt-10"/>
    <img src={blog2.src} alt="" width={700} className="pt-10"/>
    <img src={blog3.src} alt="" width={700} className="pt-10"/>
    <img src={blog4.src} alt="" width={700} className="pt-10"/>
</div>

<div className="sidebar">
    <img src={sidebr.src} alt="" className="absolute" />
</div>

<div>
    <img src={change.src} alt="" className="change" />
</div>
