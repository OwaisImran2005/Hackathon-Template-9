...
<div>
    <img src={men1.src} alt="" width={380} className="ml-60 mt-24 absolute"/>
        
    <div className="dshtxt">
        <p className="absolute font-geistsans text-4xl mt-8 font-semibold">Starter Menu</p>
        <div className="dshtxt2">

    <img src={vegtxt1.src} alt="" width={600} className="mt-4"/>
    <img src={vegtxt2.src} alt="" width={600} className="mt-4"/>
    <img src={vegtxt3.src} alt="" width={600} className="mt-4"/>
    <img src={vegtxt4.src} alt="" width={600} className="mt-4"/>
        </div>
    </div>
</div>

<div className="Menu_2">
<img src={menu2.src} alt="" width={1100} />
</div>

<div className="Menu_3">

<img src={menu3.src} alt="" />
</div>

<div className="Menu_4">
    <img src={menu4.src} alt="" width={1100} />
</div>

<div className="Menu_5">
    <img src={menu5.src} alt="" width={1100} />
</div>
...
<div>
    ...
    <img src={logomenu.src} alt="" width={1100} className="pt-14 ml-60" />
</div>
